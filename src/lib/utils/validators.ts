...
export const AssessmentSchema = z.object({
  ...
  subcutaneousFat: z.number().min(1).max(60).optional().nullable(),
  bmr: z.number().min(500).max(5000).optional().nullable(),
  metabolicAge: z.number().min(10).max(100).optional().nullable(),
  bodyWater: z.number().min(20).max(80).optional().nullable(),
